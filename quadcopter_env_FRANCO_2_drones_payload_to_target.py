...
# Pre-defined configs
##
from ._2_drones_FRANCO import _2_DRONES_PAYLOAD_CFG  # isort: skip
...
class QuadcopterEnv(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        body_1_state = self._robot.data.body_state_w[:, self._body_id_1, :]
        body_2_state = self._robot.data.body_state_w[:, self._body_id_2, :]
        payload_state = self._robot.data.body_state_w[:, self._payload_sphere_id, :3]
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        bad_tilt_1 = cos_angle_1 < 0.866 #30 degrees
        bad_tilt_2 = cos_angle_2 < 0.866 #30 degrees

        died = bad_height | bad_lin_vel_1 | bad_ang_vel_1 | bad_lin_vel_2 | bad_ang_vel_2 | bad_state | bad_tilt_1 | bad_tilt_2
